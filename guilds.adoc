...
include::all-guilds.adoc[tags=acquisitions-header;acquisitions-graph]

<<< 

include::all-guilds.adoc[tags=crafting-header;crafting-graph]

<<<

include::all-guilds.adoc[tags=explorers-header;explorers-graph]

<<<

include::all-guilds.adoc[tags=medicus-header;medicus-graph]

<<<

include::all-guilds.adoc[tags=military-header;military-graph]

<<<

include::all-guilds.adoc[tags=ritualist-header;ritualist-graph]
